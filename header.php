					...
					<div class="collapse navbar-collapse" style="opacity: 1">
						<div class="nav navbar-nav navbar-right" id="right">
							<ul class="nav navbar-nav menu">
								...
								<li><a class="item" id="item-3" href="index.php?page=dichvu" style="font-weight: bold;opacity:1;color: #FFF" >DỊCH VỤ</a></li>
								<li><a class="item" id="item-4" style="font-weight: bold;opacity:1;color: #FFF" href="pages/blog.php">BLOG</a></li>
